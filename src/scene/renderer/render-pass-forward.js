...
class RenderPassForward extends RenderPass {
    ...
    renderLayerRenderStep(step, firstStep) {
        ...
        if (cameraComponent) {
            ...
            // magnopus patched
            const originalExposure = cameraComponent.camera._exposure;
            if (this.exposure !== undefined) cameraComponent.camera._exposure = this.exposure;
            ...
            // magnopus patched
            if (this.exposure !== undefined) cameraComponent.camera._exposure = originalExposure;
        }
