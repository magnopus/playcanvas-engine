...
uniform glossStereoIsFlipped: i32; // 0: Not Flipped, 1: Flipped
#endif
...
fn getGlossiness() {
    ...
    dGlossiness = dGlossiness * uniform.material_gloss;
        ...
        // magnopus patched
        #ifdef MAG_STEREO_TEXTURE
            var stereoUV: vec2f = getStereoVideoUV({STD_GLOSS_TEXTURE_UV}, uniform.glossStereoVideoType, uniform.glossStereoIsFlipped);
