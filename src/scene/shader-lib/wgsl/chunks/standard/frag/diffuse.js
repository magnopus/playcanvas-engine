...
uniform diffuseStereoIsFlipped: i32; // 0: Not Flipped, 1: Flipped
#endif
...
fn getAlbedo() {
    dAlbedo = uniform.material_diffuse.rgb;
        ...
        // magnopus patched
        #ifdef MAG_STEREO_TEXTURE
            var stereoUV: vec2f = getStereoVideoUV({STD_DIFFUSE_TEXTURE_UV}, uniform.diffuseStereoVideoType, uniform.diffuseStereoIsFlipped);
