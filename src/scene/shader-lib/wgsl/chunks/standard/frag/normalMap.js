...
uniform normalStereoIsFlipped: i32; // 0: Not Flipped, 1: Flipped
#endif
...
fn getNormal() {
    ...
    // magnopus patched
    #ifdef MAG_STEREO_TEXTURE
    var stereoUV: vec2f = getStereoVideoUV({STD_NORMAL_TEXTURE_UV}, uniform.normalStereoVideoType, uniform.normalStereoIsFlipped);
